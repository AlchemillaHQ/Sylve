...
{/* Screenshot update needed: simple-jail-create-advanced.png. Capture the Advanced tab with FreeBSD selected, the default allowed options retained, Clean Environment enabled, and every lifecycle hook disabled. */}
