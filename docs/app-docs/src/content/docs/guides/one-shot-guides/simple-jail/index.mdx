...
import jailCreatedSummary from "./simple-jail-created-summary.png";
import jailConsoleNetwork from "./simple-jail-console-network.png";
...
import standardSwitchCreate from "./simple-jail-standard-switch-create.png";
import standardSwitchExternalConfigurationWarning from "./simple-jail-standard-switch-address-warning.png";
