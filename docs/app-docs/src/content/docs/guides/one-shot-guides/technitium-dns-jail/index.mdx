...
Please follow the instructions in the [Jellyfin Jail Guide](/guides/one-shot-guides/jellyfin-jail) to create a new jail for Technitium DNS. We're going to name our jail `TechnitiumDNS` with the hostname `technitiumdns`.
