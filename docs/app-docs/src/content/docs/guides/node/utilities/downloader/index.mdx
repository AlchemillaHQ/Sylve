...
If you have a file on your local machine that you want to add to Sylve, you can use the downloader to do that as well. Click on the "Upload" button on the top right in the context menu.

![New Upload](./upload.png)

Then you can either browser your PC or just drop in a file to upload it. After the upload is complete you can just click on "Complete Upload" and it will be added to your downloads list and you can use it just like any other download.