...
{/* Screenshot update needed: notifications-transports-overview.png. Capture the Notification Transports table with enabled examples of ntfy, Pushover, SMTP, and Discord. The Pushover row should show User / group key configured in the Destination column. */}
...
{/* Screenshot needed: notifications-transport-create-pushover.png. Capture the New Notification Transport form with Type set to Pushover, a clear transport name, both credential fields populated or masked, and Enabled selected. */}
