...
If you do want to use Static IPs (especially since only inherited/static IPs are supported for Linux jails), you can click on the generate button on the top right of each network object select box that will allow you to create Network Objects on the fly without having to leave the form. Be sure to give just one entry!

![Network - Create Object](./create-object.png)
