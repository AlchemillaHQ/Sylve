...
If you want to get going right away, run `fetch -o- sh.sylve.io | sh` on a FreeBSD >= 15 machine and open `https://<host>:8181` in your browser. For more details, continue reading.
...
- `password`: During initial setup, you can enter the password here, once that is done you can set this value to be empty, and sylve will ignore it and keep the existing password.
