...
If you want to get going right away, run `fetch -o- https://sh.sylve.io | sh` on a FreeBSD >= 15 machine and open `https://<host>:8181` in your browser. For more details, see the [getting started](/getting-started/) guide.
