...
If you want to get going right away, run `pkg install sylve` on a FreeBSD >= 15 machine and open `https://<host>:8181` in your browser. For more details, see the [getting started](/getting-started/) guide.
